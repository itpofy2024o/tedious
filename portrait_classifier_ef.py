...
def create_efficientnet_model(img_size, num_classes):
    """Creates an EfficientNetB0 model with a custom classification head."""
...
if __name__ == "__main__":
    ...
    # Create data generators with simplified augmentation
    ...
    efficientnet_model, base_model = create_efficientnet_model(img_size=img_height, num_classes=num_classes)
    ...
    checkpoint = tf.keras.callbacks.ModelCheckpoint(
        'best_efficientnet_model.keras', monitor='val_accuracy', save_best_only=True
    )
    ...
    # Evaluate the model
    val_loss, val_accuracy = efficientnet_model.evaluate(validation_generator, steps=validation_steps)
    ...
    if val_accuracy < 0.5:
        print("Fine-tuning EfficientNetB0 layers...")
    ...
    y_pred = efficientnet_model.predict(validation_generator, steps=validation_steps)
    ...
    efficientnet_model.save('efficientnetb0_classifier.keras')
    print("Training finished. Final model saved as efficientnetb0_classifier.keras")